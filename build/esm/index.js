...
const API_ENDPOINT = {
    PROD: "https://api.trymetafab.com",
};
const NETWORK = {
    ETH_MAIN: "ETHEREUM",
    ETH_TEST: "GOERLI",
    POLY_MAIN: "MATIC",
    POLY_TEST: "MATICMUMBAI",
};
const PATH = {
...
class BaseClass {
    ...
    static async call(method, baseRoute, baseHeaders, body) {
...
function get$2(gameAccessKey) {
    return BaseClass.call("GET", PATH.CURRENCIES, {
        "X-Game-Key": gameAccessKey,
    });
}
function create$2(gameSecretKey, gamePassword, newCurrency) {
    return BaseClass.call("POST", PATH.CURRENCIES, {
        "X-Authorization": gameSecretKey,
        "X-Password": gamePassword,
    }, newCurrency);
}
function getBalance(currencyId, walletAddress) {
    return BaseClass.call("GET", `${PATH.CURRENCIES}/${currencyId}/balances?address=${walletAddress}`, {});
}
...
function create$1(newGame) {
    return BaseClass.call("POST", PATH.GAMES, undefined, newGame);
}
function update$1(gameId, updateGame) {
    return BaseClass.call("PATCH", `${PATH.GAMES}/${gameId}`, undefined, updateGame);
}
...
function auth(gameAccessToken, username, password) {
...
function create(gameAccessToken, newPlayer) {
    return BaseClass.call("POST", PATH.PLAYERS, { "X-Game-Key": gameAccessToken }, newPlayer);
}
function update(playerAccessToken, playerId, updatePlayer) {
    return BaseClass.call("PATCH", `${PATH.PLAYERS}/${playerId}`, { "X-Authorization": playerAccessToken }, updatePlayer);
}
function get$1(gameAccessToken) {
...
function walletBalances(walletId) {
...
var wallets = /*#__PURE__*/Object.freeze({
	__proto__: null,
	walletBalances: walletBalances,
	walletTransactions: walletTransactions
});

class MetaFabClient extends BaseClass {
    constructor(params) {
        super({
            ...params,
...
export { API_ENDPOINT, MetaFabClient, NETWORK, PATH };
